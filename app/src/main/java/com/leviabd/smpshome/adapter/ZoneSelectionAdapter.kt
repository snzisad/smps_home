...
class ZoneSelectionAdapter (val activity: Activity, val data: ArrayList<Zones>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return BuildingListHolderClass(
            LayoutInflater.from(activity).inflate(R.layout.layout_zone_list, parent, false)
        )
    }
